...
public class Last_ManJung_Service extends Service {
    ...
    private double target[][] = SaJoData.man_target_two;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Cursor cursor = db.query("'" + Contact.LAST_MAN_WEIGHT_JUNG + "'", null, null, null, null, null, null);
    ...
    private class asyncTask extends AsyncTask<Integer, Integer, Integer> {
        ...
        protected void onPostExecute(Integer o) {
            ...
            db.insert("'" + Contact.LAST_MAN_WEIGHT_JUNG + "'", null, values);
            db.close();
