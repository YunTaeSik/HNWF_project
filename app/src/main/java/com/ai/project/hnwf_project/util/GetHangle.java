...
/*    public final static String[] ChoSung_String = {
            "ㄱ", "ㄲ", "ㄴ", "ㄷ", "ㄸ"
            , "ㄹ", "ㅁ", "ㅂ", "ㅃ", "ㅅ"
            , "ㅆ", "ㅇ", "ㅈ", "ㅉ", "ㅊ"
            , "ㅋ", "ㅌ", "ㅍ", "ㅎ"};

    public final static char[] ChoSung_UNICODE = {
    ...
    public final static String[] ChoSung_String = {  // 13개
            "ㄱ", "ㄴ", "ㄷ", "ㄹ", "ㅁ"
            , "ㅂ", "ㅅ", "ㅇ", "ㅈ", "ㅊ"
            , "ㅌ", "ㅍ", "ㅎ"};
    ...
    /*
        public final static String[] JungSung_String = {
                "ㅏ", "ㅐ", "ㅑ", "ㅒ", "ㅓ"
                , "ㅔ", "ㅕ", "ㅖ", "ㅗ", "ㅘ"
                , "ㅙ", "ㅚ", "ㅛ", "ㅜ", "ㅝ"
                , "ㅞ", "ㅟ", "ㅠ", "ㅡ", "ㅢ"
        ...
        public final static char[] JungSung_UNICODE = {
                ...
                , 0x3163};*/
    public final static String[] JungSung_String = {  //19개
            "ㅏ", "ㅐ", "ㅑ", "ㅒ", "ㅓ"
            , "ㅔ", "ㅕ", "ㅖ", "ㅗ", "ㅘ"
            , "ㅚ", "ㅛ", "ㅜ", "ㅝ", "ㅟ"
            , "ㅠ", "ㅡ", "ㅢ", "ㅣ"};
    ...
    public final static char[] JungSung_UNICODE = {
            0x314f, 0x3150, 0x3151, 0x3152, 0x3153
            , 0x3154, 0x3155, 0x3156, 0x3157, 0x3158
            , 0x315a, 0x315b, 0x315c, 0x315d, 0x315f
            , 0x3160, 0x3161, 0x3162, 0x3163};
    //  ㄼ      ㄽ       ㄾ      ㄿ      ㅀ       ㅁ       ㅂ      ㅄ      ㅅ      ㅆ      ㅇ      ㅈ       ㅊ      ㅋ      ㅌ       ㅍ      ㅎ
  /*  public final static String[] JongSung_String = {
            "", "ㄱ", "ㄲ", "ㄳ", "ㄴ"
            , "ㄵ", "ㄶ", "ㄷ", "ㄹ", "ㄺ"
            , "ㄻ", "ㄼ", "ㄽ", "ㄾ", "ㄿ"
            , "ㅀ", "ㅁ", "ㅂ", "ㅄ", "ㅅ"
    ...
    public final static char[] JongSung_UNICODE = {
            ...
            , 0x314c, 0x314d, 0x314e}; */
    public final static String[] JongSung_String = {   //6개
            " ", "ㄱ", "ㄴ", "ㄹ", "ㅁ", "ㅇ"};

    public final static char[] JongSung_UNICODE = {
            0, 0x3131, 0x3134, 0x3139, 0x3141, 0x3147
    };
