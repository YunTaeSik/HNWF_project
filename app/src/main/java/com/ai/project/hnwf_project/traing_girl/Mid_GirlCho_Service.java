 ...
 */
public class Mid_GirlCho_Service extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Cursor cursor = db.query("'" + Contact.MID_GIRL_WEIGHT_CHO + "'", null, null, null, null, null, null);
    ...
    private class asyncTask extends AsyncTask<Integer, Integer, Integer> {
        ...
        protected void onPostExecute(Integer o) {
            ...
            db.insert("'" + Contact.MID_GIRL_WEIGHT_CHO + "'", null, values);
            db.close();
